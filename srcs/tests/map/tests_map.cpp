...
/*   Updated: 2022/03/09 16:24:41 by dodjian          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* void	test_constructor_and_iterator()
{
	...
	ft::map<int> first;				// empty ft::map of ints
	ft::map<int> second(4,100);		// four ints with value 100
	ft::map<int> third(second.begin(), second.end());  // iterating through second
	ft::map<int> fourth(third); // copy
	std::cout << BYELLOW << "The contents of first are:" << BBLUE;
	for (ft::map<int>::iterator it = first.begin(); it != first.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << std::endl;
	std::cout << BYELLOW << "The contents of second(4, 100) are:" << BBLUE;
	for (ft::map<int>::iterator it = second.begin(); it != second.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << std::endl;
	std::cout << BYELLOW << "The contents of third(second.begin, second.end) are:" << BBLUE;
	for (ft::map<int>::iterator it = third.begin(); it != third.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << std::endl;
	std::cout << BYELLOW << "The contents of fourth(third) are:" << BBLUE;
	for (ft::map<int>::iterator it = fourth.begin(); it != fourth.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << std::endl;

	// the iterator constructor can also be used to construct from arrays:
	int myints[] = {16,2,77,29};
	ft::map<int> fifth(myints, myints + sizeof(myints) / sizeof(int));

	std::cout << BYELLOW << "The contents of fifth are:" << BBLUE;
	for (ft::map<int>::iterator it = fifth.begin(); it != fifth.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << std::endl;
	std::cout << BYELLOW << "The contents of fifth in reverse are:" << BBLUE;
	for (ft::map<int>::reverse_iterator it = fifth.rbegin(); it != fifth.rend(); ++it)
		std::cout << ' ' << *it;
...
void	test_relational_operators()
{
	...
	//ft::map v;
	ft::map<int> foo (3,100);	// three ints with a value of 100
	ft::map<int> bar (2,200);	// two ints with a value of 200
